...
@Component({
  selector: 'app-edit-lv-model',
  templateUrl: './edit-lv-model.component.html',
  styleUrls: ['./edit-lv-model.component.scss']
})

/**
 * Basic table component
 */
export class EditLvModelComponent implements OnInit {
  // bread crumb items
  ...
  getTrainer()
  {
    ...
    this.error = false;
    this.errorMessage = "";
    this.spservice.getLiveVideo(this.id).subscribe( resp => {
  ...
  submit()
  {
    ...
    this.spservice.updateLiveVideo(this.id, data).subscribe( resp => {
